 ...
 * misst den Wiederholweg, nicht die Pflicht selbst — die Wahl gehört deshalb in den Klickpfad wie
 * jede andere Eingabe auch, sonst hinge jede Null an der falschen Sperre. Belegt wird die Pflicht
 * in `tests/vertraulichkeit-pflicht/`.
 */
