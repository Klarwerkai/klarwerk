 ...
 * misst den Vorgangsschlüssel, nicht die Pflicht selbst — die Wahl gehört deshalb in den Klickpfad
 * wie jede andere Eingabe auch. Belegt wird die Pflicht in `tests/vertraulichkeit-pflicht/`.
 */
