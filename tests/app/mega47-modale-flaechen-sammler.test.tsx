...
// ---------------------------------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------
// (1) Die Erhebung liegt seit JOB 2008 D2 im PRODUKT: tools/modalgrenze.ts (Register A17).
//     Sie wurde NICHT umgeschrieben, nur verschoben — dieselben Zeilen, dieselbe Logik. Der
//     Test misst jetzt dasselbe Modul, das auch `tools/modalgrenze.sh` im Tor faehrt; es gibt
//     genau EINE Erhebung mit ZWEI Aufrufern statt zweier Erhebungen.
// ---------------------------------------------------------------------------------------------
// Die Erhebung kommt aus dem Produkt (JOB 2008 D2, Register A17):
import {
  FOCUSABLE_SELECTOR,
  GRENZE_MODUL,
  NATIV_MODAL_AUSNAHMEN,
  WEB_SRC,
  WURZEL,
  aufrufName,
  beurteile,
...
import type { DateiErhebung, Kandidat, KandidatArt, Urteil } from "../../tools/modalgrenze";
