...
const de = {
  ...
  "intake.done.checked": "Auf Aktualität geprüft.",
  "intake.done.credited": "Dein Name ({{name}}) ist als Quelle hinterlegt.",
...
const en: typeof de = {
  ...
  "intake.done.checked": "Checked for currency.",
  "intake.done.credited": "Your name ({{name}}) is on file as the source.",
...
const nl: typeof de = {
  ...
  "intake.done.checked": "Op actualiteit gecontroleerd.",
  "intake.done.credited": "Je naam ({{name}}) staat als bron vermeld.",
