...
// ehrlich leer (`lastConnectedAt` ist immer null, und die Fläche sagt das auch, statt zu schweigen).
//
...
export function ImportAccessPanel(): JSX.Element | null {
  ...
  return (
    <Card className="mb-5">
      ...
      {/* Ehrlich leer statt erfunden: es gibt im Bestand keinen Ort, der einen erfolgreichen
          Confluence-Kontakt festhält. Der Satz sagt das, statt die Zeile wegzulassen — eine fehlende
          Zeile läse sich wie „nie verbunden". */}
      {daten.lastConnectedAt === null ? (
