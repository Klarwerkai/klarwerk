...
// Erzähl-Einstieg · geführtes Studio · Experten-Formular · Vordertür.
export type DraftOrigin = "tell" | "studio" | "expert" | "frontdoor";
...
export function resumeTargetForDraft(payload: DraftPayload): DraftOrigin {
  if (
    payload.origin === "tell" ||
    payload.origin === "studio" ||
    payload.origin === "expert" ||
