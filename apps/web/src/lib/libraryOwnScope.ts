...
//
// FAIL-CLOSED, UND WARUM DAS HIER NICHT UEBERTRIEBEN IST: Ohne Nutzerkennung liefert die eigene
...
/** Standard ist der gesamte sichtbare Bestand, auf den man Zugriff hat. */
 ...
 * damit in keine persoenliche Ablage; im gesamten sichtbaren Bestand bleibt es erhalten.
 */
