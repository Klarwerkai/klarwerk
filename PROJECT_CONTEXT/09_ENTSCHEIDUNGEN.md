...
|---|---|---|
| 04.07.2026 | Freeze aufgehoben (Pedi); Paul arbeitet bis Di. 07.07. eigenständig, Pedi committet bei Runner-Grün (letzte Log-Zeile!); kein Push/Tag bis Di., dann v1.0.0-beta.2; Boss pausiert | Zeitgründe/Budget; Auflagen im Chat 04.07. dokumentiert |
