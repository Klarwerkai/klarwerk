...
- **Alle Gates grün** (65 Tests gesamt): Build · Lint (Biome) · Architektur (dependency-cruiser, 60 Module, 155 Abhängigkeiten inkl. Typ-Importe, Modulgrenzen nur über index) · Tests.
