...
- **Alle Gates grün** (71 Tests gesamt): Build · Lint (Biome) · Architektur (dependency-cruiser, 68 Module, 173 Abhängigkeiten inkl. Typ-Importe, Modulgrenzen nur über index) · Tests.
...
- **Deferred Infra:** Postgres-Adapter + Testcontainers (Docker), echter LLM-Provider (API-Keys), PDF-Export, E-Mail/Push-Benachrichtigungen, Audit-Verdrahtung in jede Aktion (für FR-AUD-01 / FR-RBAC-02), Cookie-Secure-Flag.
