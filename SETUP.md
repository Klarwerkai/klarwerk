...
- **Alle Gates grün** (59 Tests gesamt): Build · Lint (Biome) · Architektur (dependency-cruiser, 56 Module, 146 Abhängigkeiten inkl. Typ-Importe, Modulgrenzen nur über index) · Tests.
